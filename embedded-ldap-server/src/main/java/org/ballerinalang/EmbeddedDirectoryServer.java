...
public class EmbeddedDirectoryServer {
    ...
    public void startLdapServer(int port) throws Exception {
        ...
        //Load the LDIF file
        String ldif = new File("src" + File.separator + "test" + File.separator + "resources").getAbsolutePath()
                + File.separator + "users-import.ldif";
    ...
    public static void main(String args[]) {
        try {
            new EmbeddedDirectoryServer().startLdapServer(9389);
        } catch (Exception e) {
            //Ignore
        }
    }
